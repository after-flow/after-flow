...
const taskFields = ['title', 'summary', 'status', 'stage', 'category', 'submitTo', 'source', 'procedureId', 'dependencyTaskIds', 'requiredDocuments', 'evidenceRequired', 'assetDisposal', 'conditional']
