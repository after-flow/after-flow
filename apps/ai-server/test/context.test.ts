...
function artifact(operation: 'case_planning' | 'task_guidance' = 'case_planning') {
  const content = {
    ...
    ...(operation === 'task_guidance' ? { task: { id: 'task-1', version: 1, procedureId: 'fixture-procedure', title: '架空手続き', category: 'insurance', submitTo: '架空機関', summary: 'PRIVATE-CONTRACT-123' } } : {
      assets: [
