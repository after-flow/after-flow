...
export const liveGuidanceCases = Object.freeze([
  ...
  { id: 'unknown-branch', title: '加入していた支部が不明な場合を確認する', procedureId: 'kyoukaikenpo-burial-benefit', expectedOutcome: 'COMPLETED_RESEARCH', expectResearch: true },
  { id: 'unknown-relationship', title: '申請者との関係が不明な場合を確認する', procedureId: 'kyoukaikenpo-burial-benefit', expectedOutcome: 'MISSING_CONTEXT', expectResearch: false, omitRelationship: true },
