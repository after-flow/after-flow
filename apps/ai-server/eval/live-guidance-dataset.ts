...
export interface LiveGuidanceCase {
  ...
  /** Deliberately omit required formal context for a negative preflight case. */
...
export const liveGuidanceCases = Object.freeze([
  ...
  { id: 'unknown-branch', title: '加入していた支部が不明な場合を確認する', procedureId: 'kyoukaikenpo-burial-benefit', expectedOutcome: 'MISSING_CONTEXT', expectResearch: false, omitField: 'branch' },
  { id: 'unknown-applicant-status', title: '申請者区分が不明な場合を確認する', procedureId: 'kyoukaikenpo-burial-benefit', expectedOutcome: 'MISSING_CONTEXT', expectResearch: false, omitField: 'applicantStatus' },
